...
document.body.setAttribute('dir', 'rtl')
 $('#li-home').html('الرئيسية')
 $('#li-about').html('عن الموقع')
 $('#li-services').html('الخدمات')
 $('#li-pricing').html('العروض')
 $('#li-team').html('فريق العمل')
 $('#li-contact').html('تواصل معنا')
